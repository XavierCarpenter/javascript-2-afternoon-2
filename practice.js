...
function removeItem(myGroceryList, product) {
  for (let i = 0; i < myGroceryList.length; i++) {
    if (product == myGroceryList[i]) {
      myGroceryList.splice(i, 1);
    }
  }
  return myGroceryList;
}
function addItem(myGroceryList, product) {
  myGroceryList.push(product);
...
let crazyMan = devMountainEmployees.indexOf(cahlan);
devMountainEmployees.splice(crazyMan, 1);
...
users.useer2 = {
  ...
  email: "Xavier.Carpenter16@gmail.com",
  password: "MoneyMoney",
...
temp1 = users.indexOf("tylermcginnis33@gmail.com");
